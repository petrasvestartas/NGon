 ...
 */
    ...
    public static class PipeUtil {
        ...
        public static Pipe CreatePipe(this Line line, int id, Plane plane_, double radius, Plane cutter0, Plane cutter1, int sides = 4, double radius1 = -1, bool createBrepLoft = false) {
            ...
            Polyline poly0 = NGonCore.PolylineUtil.Polygon(s, r, p0,Math.PI*0.25,false);
            Polyline poly1 = NGonCore.PolylineUtil.Polygon(s, r1, p1, Math.PI * 0.25, false);
            ...
            if (cutter0 != Plane.Unset && cutter0 != Plane.Unset)
            {
                ...
                for (int i = 0; i < poly0.Count - 1; i++)
                {
                    ...
                    Point3d cutP0 = NGonCore.PlaneUtil.LinePlane(l, cutter0);
                    Point3d cutP1 = NGonCore.PlaneUtil.LinePlane(l, cutter1);
                    result0.Add(cutP0);
                    result1.Add(cutP1);
                }
