...
namespace NGonCore {
    public static class PlanarizeNeighbourFaces {
        ...
        public static Polyline[]  Run (this Mesh M, ref DataTree<Line> dt_) {
            ...
            foreach (var pair in efDict) {
                ...
                if (f.Length == 2) {
                    ...
                    pl1 = NGonCore.PlaneUtil.BisectorPlane(planes[f[0]], planes[f[1]]);
                    pl1.Origin = mid;
                ...
                //lines[j] = NGonCore.PlaneUtil.PlanePlane(pl0, pl1);
                Line l = NGonCore.PlaneUtil.PlanePlane(pl0, pl1);
        ...
        public static Polyline IntersectLines(Line[] lines, Line[] linesO, Plane plane) {
            ...
            for (int i = 0; i < lines.Length; i++) {
                ...
                if (l0.Direction.IsParallelTo(l1.Direction, 0.1) != 0 && false) {
                    ...
                    Point3d pMid = NGonCore.LineUtil.LineLine(l0, lMid);
                    pline.Add(pMid);

                    pMid = NGonCore.LineUtil.LineLine(lMid, l1);
                    pline.Add(pMid);
                    ...
                    Point3d p = NGonCore.LineUtil.LineLine(l0, l1);
                    pline.Add(p);
                }
