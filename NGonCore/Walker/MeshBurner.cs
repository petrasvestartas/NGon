    ...
    public static class MeshBurner {
        ...
        public  static List<Mesh> meshBurnerNgons(Mesh m) {
            ...
            while (mesh.Faces.Count > 0 && i < 10) {
                ...
                Mesh bm0 = NGonCore.MeshCreate.MeshFromPolylines(bmPolys0, Rhino.RhinoDoc.ActiveDoc.ModelAbsoluteTolerance);
                Mesh bm1 = NGonCore.MeshCreate.MeshFromPolylines(bmPolys1, Rhino.RhinoDoc.ActiveDoc.ModelAbsoluteTolerance);
                // bm0.Clean();
                // bm1.Clean();
                //bm0.UnifyNormals();
                //bm0.RebuildNormals();
