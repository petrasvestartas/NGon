    ...
    public static class UndirectedGraphBfsRhino {
        ...
        public static bool[][] CheckerEdges(this Mesh M) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                Tuple<List<List<int>>, List<List<int[]>>> bfs = NGonCore.Graphs.UndirectedGraphBfsRhino.MeshBFS(M, start);
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (i == 0) {
                    ...
                    */
                    ...
                    //for (int j = 0; j < mes.Length; j++) {
                    //    int nextMeshEdge = mes[NGonCore.MathUtil.Wrap(j + fe + 1, mes.Length)];
        ...
        public static bool[] Checker(this Mesh mesh) {
            Tuple<List<List<int>>, List<List<int[]>>> bfs = NGonCore.Graphs.UndirectedGraphBfsRhino.MeshBFS(mesh, "0");
