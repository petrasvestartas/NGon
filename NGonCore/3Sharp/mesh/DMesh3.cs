...
namespace g3
{
    ...
    //    The can have custom accessor that looks up entire tuple
        ...
        public static class g3Rhino {
        public static DMesh3 ToDMesh3(this Rhino.Geometry.Mesh mesh, int groupID) {
            ...
            //if (groupID != -1) {
                //Rhino.RhinoApp.WriteLine("TriangleGroups");
                dMesh3.EnableTriangleGroups(groupID);

            //}

            foreach (var face in mesh.Faces) {
              
                dMesh3.AppendTriangle(face.A, face.B, face.C,groupID);
            }
        ...
        public static DMesh3 ToDMesh3(this Rhino.Geometry.Mesh mesh) {
            var dMesh3 = new DMesh3();
        ...
        public static Rhino.Geometry.Mesh ToRhinoMesh(this DMesh3 dMesh3) {
            dMesh3 = new DMesh3(dMesh3, true, MeshComponents.All);
            var mesh = new Rhino.Geometry.Mesh();

            var vertices = dMesh3.Vertices().Select(v => new Rhino.Geometry.Point3d(v.x, v.z, v.y));
            var faces = dMesh3.Triangles().Select(f => new Rhino.Geometry.MeshFace(f.a, f.b, f.c));
