...
namespace NGonCore {
    public class QuickHullRhino {
        ...
        public QuickHullRhino(IEnumerable<Point3d> Points) {
            this._mesh = null;
            ...
            this.Mesh = new Mesh();
            this.Mesh.Vertices.AddVertices(Points);
        ...
        //            Rhino.RhinoApp.WriteLine(to.Length.ToString());
        //        }
        //    }
        ...
        private void ComputePlanes(int From = 0) {
            ...
            for (int i = From; i <= count; i++) {
                this.FacePlanes.Add(new Plane(this.Mesh.Faces.GetFaceCenter(i), this.Mesh.FaceNormals[i]));
            ...
            while (true) {
                if (count > 0) {
                    ...
                    if (num1 == -1) {
                        ...
                        this.Mesh.Faces.AddFace(new MeshFace(numArray[2], numArray[1], numArray[0] ));
                        this.Mesh.Faces.AddFace(new MeshFace( num1, numArray[0], numArray[1]));
                        this.Mesh.Faces.AddFace(new MeshFace( num1, numArray[1], numArray[2] ));
                        this.Mesh.Faces.AddFace(new MeshFace( num1, numArray[2], numArray[0] ));
        ...
        private bool RemoveVisibleFaces(int Index) {
            ...
            List<MeshFace> polyFaces = new List<MeshFace>();
            ...
            this.Mesh.Faces.AddFaces(polyFaces);
