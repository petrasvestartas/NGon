...
namespace NGon_RH8.Graphs {
    public class MeshCurve : GH_Component {
        ...
        protected override void SolveInstance(IGH_DataAccess DA) {
            ...
            List<double> r = NGonCore.Clipper.DataAccessHelper.FetchList<double>(DA, "Radius");
            double VDist = NGonCore.Clipper.DataAccessHelper.Fetch<double>(DA, "VDist");
            int U = NGonCore.Clipper.DataAccessHelper.Fetch<int>(DA, "U");
            int V = NGonCore.Clipper.DataAccessHelper.Fetch<int>(DA, "V");
            List<Circle> circlesRadius = NGonCore.Clipper.DataAccessHelper.FetchList<Circle>(DA, "Circles");
           ...
           Mesh mesh =  NGonCore.Graphs.LineGraph.CurveMesh(RhinoLines, r, VDist, U, V, ref anchors0, ref anchors1, ref outlines,ref circles,circlesRadius);
