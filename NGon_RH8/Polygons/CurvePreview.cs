...
namespace NGon_RH8.Utils {
    public class CurvePreview : GH_Component {
        ...
        protected override void SolveInstance(IGH_DataAccess DA) {
            ...
            GH_Structure<GH_Curve> curve = NGonCore.Clipper.DataAccessHelper.FetchTree<GH_Curve>(DA, "Curve");
            ...
            if (flag) {
                GH_Structure<GH_Integer> width = NGonCore.Clipper.DataAccessHelper.FetchTree<GH_Integer>(DA, "Width");
                GH_Structure<GH_Colour> colour = NGonCore.Clipper.DataAccessHelper.FetchTree<GH_Colour>(DA, "Colour");
