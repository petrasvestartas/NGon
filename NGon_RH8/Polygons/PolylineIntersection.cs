...
namespace NGon_RH8.Polylines
{
    public class PolylineIntersection : GH_Component {
        ...
        {
            List<Curve> curves = NGonCore.Clipper.DataAccessHelper.FetchList<Curve>(DA, "Curve0");
            List<Curve> cutters = NGonCore.Clipper.DataAccessHelper.FetchList<Curve>(DA, "Curve1");

            var result = NGonCore.Geometry.RhinClip.BooleanIntersection(curves, cutters, 0);
