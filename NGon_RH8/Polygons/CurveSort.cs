...
namespace NGon_RH8.SubD {
    public class CurveSort : GH_Component {
        ...
        protected override void SolveInstance(IGH_DataAccess DA) {
            ...
            List<Curve> CurvesGuide= NGonCore.Clipper.DataAccessHelper.FetchList<Curve>(DA, "CurvesGuide");
            List<Curve> CurvesToSort = NGonCore.Clipper.DataAccessHelper.FetchList<Curve>(DA, "CurvesToSort");
