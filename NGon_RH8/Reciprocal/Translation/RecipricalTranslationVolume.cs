...
namespace NGon_RH8.Utils {
    public class RecipricalTranslationVolume : GH_Component {
        ...
        protected override void SolveInstance(IGH_DataAccess DA) {
            ...
            NGonCore.Nexorades.Nexors nexors0 = DA.Fetch<NGonCore.Nexorades.Nexors>("Nexors0");

            MeshProps meshProps1 = DA.Fetch<MeshProps>("MeshProp1");
            NGonCore.Nexorades.Nexors nexors1 = DA.Fetch<NGonCore.Nexorades.Nexors>("Nexors1");
