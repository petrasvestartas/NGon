...
namespace NGonsCore.Text
{
    public static class BBPolyline
    {
        ...
        private static Plane GetPlane(IEnumerable<Rhino.Geometry.Curve> curves, Plane? plane)
        {
            if (plane.HasValue)
                return plane.Value;
        ...
        private class PolylineInt : List<IntPoint>
        {
            ...
            public Rhino.Geometry.Curve ToCurve(Plane plane, Point2d origin, double unit)
            {
