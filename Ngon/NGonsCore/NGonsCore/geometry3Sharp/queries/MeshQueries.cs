...
namespace NGonsCore.geometry3Sharp.queries
{
    public static class MeshQueries
    {
        ...
        public static double TriDistanceSqr(NGonsCore.geometry3Sharp.mesh.DMesh3 mesh, int ti, Vector3D point)
        {
        ...
        public static int FindNearestVertex_LinearSearch(NGonsCore.geometry3Sharp.mesh.DMesh3 mesh, Vector3D p)
        {
            int vNearest = NGonsCore.geometry3Sharp.mesh.DMesh3.InvalidID;
        ...
        // brute force search for nearest triangle to point
        public static int FindNearestTriangle_LinearSearch(NGonsCore.geometry3Sharp.mesh.DMesh3 mesh, Vector3D p)
        {
            int tNearest = NGonsCore.geometry3Sharp.mesh.DMesh3.InvalidID;
            double fNearestSqr = double.MaxValue;
        ...
        public static void EdgeLengthStats(NGonsCore.geometry3Sharp.mesh.DMesh3 mesh, out double minEdgeLen, out double maxEdgeLen, out double avgEdgeLen, int samples = 0)
        {
