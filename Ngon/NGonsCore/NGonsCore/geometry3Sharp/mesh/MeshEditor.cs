...
namespace NGonsCore.geometry3Sharp.mesh
{
    ...
    public class MeshEditor
    {
        ...
        public MeshEditor(NGonsCore.geometry3Sharp.mesh.DMesh3 mesh)
        {
            Mesh = mesh;
        }
        ...
        public virtual int[] StitchLoop(int[] vloop1, int[] vloop2, int group_id = -1)
        {
            ...
            for ( ; i < N; ++i ) {
                ...
                if (tid1 == NGonsCore.geometry3Sharp.mesh.DMesh3.InvalidID || tid2 == NGonsCore.geometry3Sharp.mesh.DMesh3.InvalidID)
                    goto operation_failed;
        ...
        public bool RemoveTriangles(int[] triangles, bool bRemoveIsolatedVerts)
        {
            ...
            for (int i = 0; i < triangles.Length; ++i ) {
                if (triangles[i] == NGonsCore.geometry3Sharp.mesh.DMesh3.InvalidID)
                    continue;
