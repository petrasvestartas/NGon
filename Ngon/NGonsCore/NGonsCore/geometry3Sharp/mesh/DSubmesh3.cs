...
namespace NGonsCore.geometry3Sharp.mesh
{
    ...
    {
        public NGonsCore.geometry3Sharp.mesh.DMesh3 BaseMesh;
        public NGonsCore.geometry3Sharp.mesh.DMesh3 SubMesh;
        ...
        public DSubmesh3(NGonsCore.geometry3Sharp.mesh.DMesh3 mesh, int[] subTriangles)
        {
            BaseMesh = mesh;
            compute(subTriangles, subTriangles.Length);
        }
        public DSubmesh3(NGonsCore.geometry3Sharp.mesh.DMesh3 mesh, IEnumerable<int> subTriangles, int nTriEstimate = 0)
        {
            BaseMesh = mesh;
        ...
        public int MapVertexToBaseMesh(int sub_vID) {
            ...
            return NGonsCore.geometry3Sharp.mesh.DMesh3.InvalidID;
        }
        ...
        public static NGonsCore.geometry3Sharp.mesh.DMesh3 QuickSubmesh(NGonsCore.geometry3Sharp.mesh.DMesh3 mesh, IEnumerable<int> triangles) {
