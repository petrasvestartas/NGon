...
namespace NGonsCore.geometry3Sharp.mesh
{
    ...
    public class EdgeLoopRemesher : Remesher
    {
        ...
        Vector3D loop_smooth_vertex(NGonsCore.geometry3Sharp.mesh.DMesh3 mesh, int vid, double alpha)
        {
        ...
        protected override void OnEdgeSplit(int edgeID, int va, int vb, NGonsCore.geometry3Sharp.mesh.DMesh3.EdgeSplitInfo splitInfo)
        {
        ...
        protected override void OnEdgeCollapse(int edgeID, int va, int vb, NGonsCore.geometry3Sharp.mesh.DMesh3.EdgeCollapseInfo collapseInfo)
        {
