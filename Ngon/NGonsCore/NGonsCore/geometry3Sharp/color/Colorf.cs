...
namespace NGonsCore.geometry3Sharp.color
{
    public struct Colorf : IComparable<Colorf>, IEquatable<Colorf>
    {
        ...
        public Colorf(int r, int g, int b, int a = 255) {
            this.r = math.MathUtil.Clamp((float)r, 0.0f, 255.0f) / 255.0f;
            this.g = math.MathUtil.Clamp((float)g, 0.0f, 255.0f) / 255.0f;
            this.b = math.MathUtil.Clamp((float)b, 0.0f, 255.0f) / 255.0f;
            this.a = math.MathUtil.Clamp((float)a, 0.0f, 255.0f) / 255.0f;
        }
