...
namespace NGonsCore.geometry3Sharp.color
{
    public class ColorHSV
    {
        ...
        public Colorf ConvertToRGB()
        {
            ...
            if (h < 0)
                h += 360;
            h = math.MathUtil.Clamp(h, 0.0f, 360.0f);
            s = math.MathUtil.Clamp(s, 0.0f, 1.0f);
            v = math.MathUtil.Clamp(v, 0.0f, 1.0f);
            float c = v * s;
            ...
            return new Colorf(
                math.MathUtil.Clamp(rp + m,0,1), 
                math.MathUtil.Clamp(gp + m,0,1), 
                math.MathUtil.Clamp(bp + m,0,1), this.a);
        }
