namespace NGonsCore.geometry3Sharp.color
{
    public struct Colorb
    {
        ...
        public Colorb(float r, float g, float b, float a = 1.0f) {
            this.r = (byte)math.MathUtil.Clamp((int)(r * 255.0f), 0, 255);
            this.g = (byte)math.MathUtil.Clamp((int)(g * 255.0f), 0, 255);
            this.b = (byte)math.MathUtil.Clamp((int)(b * 255.0f), 0, 255);
            this.a = (byte)math.MathUtil.Clamp((int)(a * 255.0f), 0, 255);
        }
