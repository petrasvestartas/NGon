...
namespace NGonsCore.geometry3Sharp.curve 
{
	...
	public class PlanarComplex 
	{
		...
		public bool JoinElements(ComplexEndpoint2d a, ComplexEndpoint2d b, double loop_tolerance = math.MathUtil.ZeroTolerance) {
        ...
        public void ConvertToLoop(SmoothCurveElement curve, double tolerance = math.MathUtil.ZeroTolerance)
        {
		...
		public SolidRegionInfo FindSolidRegions(double fSimplifyDeviationTol = 0.1, bool bWantCurveSolids = true) 
		{
            ...
            for (int i = 0; i < N; ++i) {
                ...
                GeneralPolygon2d g = new GeneralPolygon2d {Outer = outer_poly};
