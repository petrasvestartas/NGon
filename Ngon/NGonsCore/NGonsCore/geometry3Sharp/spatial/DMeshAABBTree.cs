...
namespace NGonsCore.geometry3Sharp.spatial
{
    public class DMeshAABBTree3 : ISpatial
    {
        ...
        public DMeshAABBTree3(NGonsCore.geometry3Sharp.mesh.DMesh3 m)
        {
            mesh = m;
        }
        ...
        public int FindNearestTriangle(Vector3D p, double fMaxDist = double.MaxValue)
        {
            ...
            int tNearID = NGonsCore.geometry3Sharp.mesh.DMesh3.InvalidID;
        ...
        void find_hit_triangle(int iBox, ref Ray3d ray, ref double fNearestT, ref int tID)
        {
            ...
            if ( idx < triangles_end ) {            // triange-list case, array is [N t1 t2 ... tN]
                ...
                double e = math.MathUtil.ZeroTolerancef;
            ...
            boxes_set tris, boxes_set nodes, out AxisAlignedBox3f box)
        {
            ...
            int n0, n1;
            if (Math.Abs(interval.a - interval.b) > math.MathUtil.ZeroTolerance) {
        ...
        AxisAlignedBox3f get_box(int iBox)
        {
            ...
            e += 10.0f*math.MathUtil.Epsilonf;      // because of float/double casts, box may drift to the point
            ...
            TreeTraversal t = new TreeTraversal() {
                NextTriangleF = (tID) => {
                    ...
                    if (fTriDistSqr < fBoxDistSqr)
                        if ( Math.Abs(fTriDistSqr - fBoxDistSqr) > math.MathUtil.ZeroTolerance*100 )
                            Util.gBreakToDebugger();
                }
            };
