...
namespace NGonsCore.geometry3Sharp.approximation
{
    ...
    public class BiArcFit2
    {
        ...
        public double Epsilon = math.MathUtil.ZeroTolerance;
        ...
        void Fit()
        {
            ...
            // original code used 0.0001 here...
            bool equalTangents = math.MathUtil.EpsilonEqual(tMagSqr, 4.0, Epsilon);
            //var equalTangents = IsEqualEps(tMagSqr, 4.0);

            double vDotT1 = v.Dot(t1);
            bool perpT1 = math.MathUtil.EpsilonEqual(vDotT1, 0.0, Epsilon );
