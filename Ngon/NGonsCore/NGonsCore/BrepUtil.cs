...
namespace NGonsCore{
    public static class BrepUtil {
        ...
        public static Brep Loft(Curve c0, Curve c1, bool closed = false) {
            ...
            Brep loft = Brep.CreateFromLoft(new Curve[] { c0, c1 }, Point3d.Unset, Point3d.Unset, LoftType.Normal, false)[0];
        ...
        public static bool IntersectBreps2x2(List<Brep> panels, List<Brep> foundations, ref Polyline[] intersection0, ref Polyline[] intersection1) {
            ...
            if (c0 != Line.Unset) {
                ...
                Point3d pm0 = NGonsCore.PlaneUtil.LinePlane(c0, plane);
                Point3d pm1 = NGonsCore.PlaneUtil.LinePlane(c1, plane);
                Point3d pm2 = NGonsCore.PlaneUtil.LinePlane(c2, plane);
                Point3d pm3 = NGonsCore.PlaneUtil.LinePlane(c3, plane);
