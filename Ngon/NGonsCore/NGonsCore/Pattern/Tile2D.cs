...
namespace NGonsCore {
    public class Tile2D {
        ...
        public void Map(Polyline targetPolyline) {
            ...
            //return NGonsCore.PolylineUtil.MappedFromSurfaceToSurface(TC, b0.Surfaces[0], b1.Surfaces[0]);
            for(int i = 0; i < this.geo.Length; i++) {
                this.geo[i] = NGonsCore.PolylineUtil.MappedFromMeshToMesh(this.geo[i], m0, m1);
            }
