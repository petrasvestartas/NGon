...
namespace NGonGh.Graphs {
    public class ConvexHull : GH_Component {
        ...
        protected override void SolveInstance(IGH_DataAccess DA) {
            ...
            plane.Origin=NGonsCore.PointUtil.AveragePoint(points);
            ...
            if(t < Rhino.RhinoDoc.ActiveDoc.ModelAbsoluteTolerance) {
                ...
                ConvexHull<DefaultVertex, DefaultConvexFace<DefaultVertex>> hull = NGonsCore.ConvexHull.ConvexHull.Create(points,true);

                Polyline polyline = new Polyline();
                foreach (NGonsCore.ConvexHull.DefaultVertex pt in hull.Points) {
                ...
                ConvexHull<DefaultVertex, DefaultConvexFace<DefaultVertex>> hull = NGonsCore.ConvexHull.ConvexHull.Create(points,false);
