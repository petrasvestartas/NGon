...
namespace NGonGh.Polygons {
    public class MeshCP : GH_Component {
  
        public MeshCP()
          : base("MeshCP", "MeshCP",
              "Is point close to a mesh or is inside mesh",
              "NGon", "Utilities Mesh") {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA) {
            ...
            List<Point3d> cp = c.IsPointsInsideMesh(points, ref id, t);
        ...
        protected override System.Drawing.Bitmap Icon {
            get {
                ...
                return Properties.Resources.MeshCP;
            }
        }

        public override Guid ComponentGuid {
            get { return new Guid("537599f5-680a-44dd-8ad2-d5bd06898fa6"); }
        }
    }
}