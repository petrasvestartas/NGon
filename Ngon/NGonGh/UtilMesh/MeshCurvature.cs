...
namespace NGonGh.Utils {
    public class Mesh_Cuvarture_Component : GH_Component {
        ...
        Mesh mesh = new Mesh();
        NGonsCore.MeshUtilSimple.Mesh_Cuvature_Utilities_Debugging mainK;
        double v1;
        double v2;
        ...
        protected override void SolveInstance(IGH_DataAccess DA) {
           ...
           // DA.GetData(5, ref animate);
            ...
            #region
                ...
                if (run) {
                    mainK = NGonsCore.MeshUtilSimple.Mesh_Cuvature_Utilities_Debugging.MainK(d1, !d1, (int)distance, aMeshEdgeLength * distance, method, curvatureType, mesh, topvertex);
