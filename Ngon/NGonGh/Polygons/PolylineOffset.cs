...
namespace NGonGh.Polylines
{
    public class PolylineOffset : GH_Component {
        ...
        protected override void SolveInstance(IGH_DataAccess DA) {
            ...
            double distance = NGonsCore.Clipper.DataAccessHelper.Fetch<double>(DA, "Distance");
             double D = NGonsCore.Clipper.DataAccessHelper.Fetch<double>(DA, "Divisions");
            ...
            if (distance < 0.00001) {
                ...
                NGonsCore.Geometry.Polyline3D.Offset(poly, distance, out c, out h);
