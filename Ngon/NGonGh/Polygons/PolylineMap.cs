...
namespace NGonGh.Polylines
{
    public class PolylineMap : GH_Component {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Curve source0 = NGonsCore.Clipper.DataAccessHelper.Fetch<Curve>(DA, "Source0");
            Curve target0 = NGonsCore.Clipper.DataAccessHelper.Fetch<Curve>(DA, "Target0");
            Curve source1 = null;
            Curve target1 = null;
            source1 = NGonsCore.Clipper.DataAccessHelper.Fetch<Curve>(DA, "Source1");
             target1 = NGonsCore.Clipper.DataAccessHelper.Fetch<Curve>(DA, "Target1");



            DA.SetDataList(0,NGonsCore.Mapping.MapCurve(curves, target0, source0, null, null));
